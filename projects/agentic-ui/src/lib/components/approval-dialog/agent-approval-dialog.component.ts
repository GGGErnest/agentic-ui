...
@Component({
      ...
      <div class="approval-backdrop" (click)="onBackdropClick()">
        <div class="approval-dialog" (click)="$event.stopPropagation()">
          ...
          <div class="approval-dialog__body">
            <p class="approval-dialog__intro">Agent wants to execute a destructive action:</p>
          ...
          <div class="approval-dialog__actions">
            <button class="approval-dialog__btn approve" (click)="approve()">✅ Approve</button>
            <button class="approval-dialog__btn reject" (click)="reject()">❌ Reject</button>
          </div>
        </div>
      </div>
    }
  ...
  styles: [
    `
      ...
      .approval-dialog__row:last-child {
        border-bottom: none;
      }
      ...
      .approval-dialog__btn.approve:hover {
        background: #2ea043;
      }
      ...
      .approval-dialog__btn.reject:hover {
        background: #30363d;
      }
    `,
  ],
